...
- Top-down view
- 2 players
- Options menu (volume, language, controls remapping, ...)
- Full controller support
- 4 rooms (hall, outdoors, office, workshop)
- 8 types of waste (paper, plastic, metal, glass, organic, electronic, clothes, other)
- Money system
- Achievement system
- Skill tree for each player (eg: speed, weight, building)
- Bots that can help the players (must be bought)
...
- It can be played offline or in local
- Support of a maximum of controllers
- Support devices with low performances
- Cross-platform (Windows, Linux, MacOS, Android, iOS, Html5 ?)
- Code optimization
- Publishing on itch.io
- Low size of assets and game
